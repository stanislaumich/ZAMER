...
begin
  ...
  QTemp.ParamByName('u1').AsFloat:=0;//Simpleroundto(USred.Value, RazU);
  QTemp.ParamByName('u2').AsFloat:=0;//Simpleroundto(USred.Value, RazU);
  QTemp.ParamByName('u3').AsFloat:=0;//Simpleroundto(USred.Value, RazU);


  QTemp.ParamByName('i1').AsFloat:=0;//Simpleroundto(USred.Value, RazI);
  QTemp.ParamByName('i2').AsFloat:=0;//Simpleroundto(USred.Value, RazI);
  QTemp.ParamByName('i3').AsFloat:=0;//Simpleroundto(USred.Value, RazI);

  QTemp.ParamByName('p1').AsFloat:=0;//Simpleroundto(USred.Value, RazP);
  QTemp.ParamByName('p2').AsFloat:=0;//Simpleroundto(USred.Value, RazP);
  QTemp.ParamByName('p3').AsFloat:=0;//Simpleroundto(USred.Value, RazP);
