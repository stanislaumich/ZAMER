...
begin
    ...
    try
        ...
        wrepl('N21x', myformat('0.00',
          strtofloat(Fnagr.StringGrid1.Cells[2, 2])));
        // i
        wrepl('N12x', myformat('0.0',
          strtofloat(Fnagr.StringGrid1.Cells[3, 1])));
        wrepl('N22x', myformat('0.0',
          strtofloat(Fnagr.StringGrid1.Cells[3, 2])));
        // p
        wrepl('N13x', myformat('0.0',
          strtofloat(Fnagr.StringGrid1.Cells[4, 1])));
        wrepl('N23x', myformat('0.0',
          strtofloat(Fnagr.StringGrid1.Cells[4, 2])));
        // n
        wrepl('N14x', myformat('0.0',
          strtofloat(Fnagr.StringGrid1.Cells[5, 1])));
        wrepl('N24x', myformat('0.0',
          strtofloat(Fnagr.StringGrid1.Cells[5, 2])));
        // m
        wrepl('N15x', myformat('0.0',
          strtofloat(Fnagr.StringGrid1.Cells[6, 1])));
        wrepl('N25x', myformat('0.0',
          strtofloat(Fnagr.StringGrid1.Cells[6, 2])));
        // t1
        wrepl('N16x', myformat('0.0',
          strtofloat(Fnagr.StringGrid1.Cells[7, 1])));
        wrepl('N26x', myformat('0.0',
          strtofloat(Fnagr.StringGrid1.Cells[7, 2])));
        // t2
        wrepl('N17x', myformat('0.0',
          strtofloat(Fnagr.StringGrid1.Cells[8, 1])));
        wrepl('N27x', myformat('0.0',
          strtofloat(Fnagr.StringGrid1.Cells[8, 2])));
        // t3
        wrepl('N18x', myformat('0.0',
          strtofloat(Fnagr.StringGrid1.Cells[9, 1])));
        wrepl('N28x', myformat('0.0',
          strtofloat(Fnagr.StringGrid1.Cells[9, 2])));
        // r
