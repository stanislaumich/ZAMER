		...
		for i                := 1 to StringGrid1.rowcount - 1 do
			...
			begin
				...
				StringGrid2.cells[0, i] :=
				  Floattostr(simpleroundto(Strtofloat(Label10.Caption) * 1000 /
				  100 * Strtoint(StringGrid1.cells[1, i]), RazP));
			end;
	...
	begin
		...
		for i                := 1 to StringGrid1.rowcount - 1 do
			...
			begin
				...
				StringGrid2.cells[0, i] :=
				  Floattostr(simpleroundto(Strtofloat(Label10.Caption) * 1000 /
				  100 * Strtoint(StringGrid1.cells[2, i]), RazP));
			end;
		StringGrid2.cells[0, StringGrid2.rowcount - 1] := '';
		StringGrid2.row                                := 1;
		tipispyt                                       := 2;
	...
	begin
		...
		for i                := 1 to StringGrid1.rowcount - 1 do
			...
			begin
				...
				StringGrid2.cells[0, i] :=
				  Floattostr(simpleroundto(Strtofloat(Label10.Caption) * 1000 /
				  100 * Strtoint(StringGrid1.cells[3, i]), RazP));
			end;
		StringGrid2.cells[0, StringGrid2.rowcount - 1] := '';
		StringGrid2.row                                := 1;
		tipispyt                                       := 3;
...
begin
	...
	begin
		...
		Edit3.Text     :=
		  Floattostr(simpleroundto(Strtofloat(StringGrid2.cells[0,
...
begin
	...
	begin
		...
		StringGrid2.cells[7, StringGrid2.row] :=
		  Floattostr(simpleroundto(Qselectsred.FieldByName('pmax')
		  .AsFloat, RazP));
		/// //////////////////////////////////////////////////////////////////////////
